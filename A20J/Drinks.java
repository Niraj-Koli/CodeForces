 ...
 * 
 * Input
 * The first input line contains a single integer n (1 ≤ n ≤ 100) — the number
 * of orange-containing drinks in Vasya's fridge. The second line contains n
 * integers pi (0 ≤ pi ≤ 100) — the volume fraction of orange juice in the i-th
 * drink, in percent. The numbers are separated by a space.
 * 
 * Output
...
public class Drinks {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            sumOfFractions = sumOfFractions + io.nextInt();
        }

        System.out.println(sumOfFractions / n);
